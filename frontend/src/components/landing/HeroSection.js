    ...
    <section className="relative py-20 md:py-28 px-6 lg:px-8 overflow-hidden" data-testid="hero-section">
      ...
      <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-14 items-center">
        ...
        <div className="lg:col-span-3 snap-in">
          <div className="inline-flex items-center gap-2 bg-[#FFF8EE] dark:bg-[#1B1409] text-[#92400E] border border-[#FEF3C7] dark:border-[#4A3614] rounded-full px-4 py-1.5 mb-7 shadow-sm" data-testid="hero-badge">
          ...
          <h1 className="hero-headline text-5xl md:text-6xl lg:text-[68px] text-[#0A1118] dark:text-[#FFFBF5] mb-6" data-testid="hero-headline">
          ...
          <p className="font-body text-base md:text-lg text-[#334155] dark:text-[#CBD5E1] leading-relaxed mb-10 max-w-xl">
            {t.heroSubtextV2}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-10">
            ...
            <a href="#emi-calculator">
              <Button className="snap-press bg-white dark:bg-[#0B121C] text-[#0A1118] dark:text-[#FFFBF5] hover:bg-[#FFFBF5] dark:bg-[#050810] rounded-xl px-8 h-14 font-body font-bold text-base border-2 border-[#0A1118] shadow-sm" data-testid="hero-emi-btn">
                {t.tryEmiCalculator}
              </Button>
            </a>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 max-w-xl">
            {[
              ...
              <div key={i} className="border-l-2 border-[#FEF3C7] dark:border-[#4A3614] pl-3">
                <div className="data-large text-2xl text-[#0A1118] dark:text-[#FFFBF5]">{s.num}</div>
                <div className="font-body text-xs text-[#64748B] dark:text-[#94A3B8] dark:text-[#64748B] mt-0.5">{s.label}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="bismuth-tile bismuth-tile-best p-7 relative">
            ...
            <div className="relative z-10 mt-2">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <div className="font-heading font-bold text-base text-[#0A1118] dark:text-[#FFFBF5]">HDFC Personal Loan</div>
                  <div className="font-body text-xs text-[#64748B] dark:text-[#94A3B8] dark:text-[#64748B]">{t.personalLoan}</div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-5 mb-5">
                <div>
                  ...
                  <div className="data-large text-2xl text-[#0A1118] dark:text-[#FFFBF5]">10.5<span className="text-sm text-[#94A3B8] dark:text-[#64748B] font-medium">%</span></div>
                </div>
                <div>
                  <div className="cap mb-1">{t.emiEst}</div>
                  <div className="data-large text-2xl text-[#0A1118] dark:text-[#FFFBF5]">₹21,247</div>
                  <div className="font-body text-[10px] text-[#94A3B8] dark:text-[#64748B]">per month</div>
                </div>
                <div>
                  <div className="cap mb-1">{t.totalCostLabel}</div>
                  <div className="data-large text-2xl text-[#0A1118] dark:text-[#FFFBF5]">₹7,64,892</div>
                </div>
                <div>
                  <div className="cap mb-1">{t.approvalOddsLabel}</div>
                  <div className="inline-flex items-center bg-[#DCFCE7] dark:bg-[#0E2818] text-[#166534] font-numbers font-bold text-base rounded-full px-3 py-1 mt-0.5">89%</div>
                </div>
              </div>

              <div className="pt-4 border-t border-[#E5E7EB] dark:border-[#1F2A3D] flex items-center justify-between">
                <div className="font-body text-[10px] text-[#94A3B8] dark:text-[#64748B]">{t.based500k36mo}</div>
