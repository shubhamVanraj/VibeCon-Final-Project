        ...
        <Card className="rounded-2xl border border-black/5 shadow-[0_4px_24px_rgba(0,0,0,0.04)] bg-white/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-4">
            <form onSubmit={handleSubmit} className="space-y-4">
              {error && (
                <div className="bg-red-50 text-red-600 text-sm p-3 rounded-xl font-body" data-testid="register-error">{error}</div>
              )}
          ...
          <CardFooter className="justify-center">
            <p className="text-sm text-[#4B5563] font-body">
              ...
              <Link to="/login" className="text-[#059669] hover:underline font-semibold" data-testid="login-link">Sign in</Link>
            </p>
          </CardFooter>
        </Card>
      </div>
